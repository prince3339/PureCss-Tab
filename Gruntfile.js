module.exports = function(grunt) {
    ...
    grunt.task.registerTask('pepper-process', ['sass', 'autoprefixer', 'processhtml']); //register a task to automate all tasks

    grunt.task.registerTask('pepper-minify', ['htmlmin', 'cssmin', 'uglify']); //register a task to automate all tasks
};
